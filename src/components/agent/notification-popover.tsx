...
type AgentNotificationPopoverProps = Readonly<{
...
export const AgentNotificationPopover = ({
  notifications,
}: AgentNotificationPopoverProps): React.JSX.Element => {
  const { unreadCount, isRead, markAsRead, markAllAsRead } = useAgentNotifications()
