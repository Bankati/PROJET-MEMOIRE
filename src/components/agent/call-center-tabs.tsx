        ...
        {tabs.map((tab) => (
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-all ${
              activeTab === tab.id
                ? "border-b-2 border-lbs-blue text-lbs-blue dark:border-blue-400 dark:text-blue-300"
          ...
          <div className="h-full">
            {pdfUrl !== null && pdfUrl.length > 0 ? (
              ...
              <div className="flex h-48 flex-col items-center justify-center gap-3 text-center">
                ...
                <p className="text-sm font-medium text-zinc-600 dark:text-zinc-300">Aucun document disponible</p>
                <p className="text-xs text-zinc-400 dark:text-zinc-500">
                  L&apos;administrateur n&apos;a pas encore associé de document PDF à cette campagne.
                </p>
              </div>
            )}
          </div>
