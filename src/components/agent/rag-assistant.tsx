  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: 'welcome',
      role: 'assistant',
      content: `Bonjour ! Je suis votre assistant pour l'appel avec ${contactName}${schoolName ? ` de ${schoolName}` : ''}${desiredProgram ? `, intéressé(e) par la filière **${desiredProgram}**` : ''}. Posez-moi une question ou utilisez les suggestions rapides.`,
    },
  ])
