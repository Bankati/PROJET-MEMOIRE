    ...
    return (
      <input
        ...
        className={cn(
          ...
          'focus:border-lbs-blue focus:ring-lbs-blue/15 focus:ring-2 focus:outline-none',
          'disabled:cursor-not-allowed disabled:opacity-50',
          'dark:bg-lbs-surface-dark-3 dark:border-white/[0.12] dark:text-white dark:placeholder:text-gray-500',
