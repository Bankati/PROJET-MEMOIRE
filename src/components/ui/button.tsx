...
const buttonVariants = cva(
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold tracking-wide transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-lbs-blue/30 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.97] [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        default:
          'bg-gradient-to-b from-lbs-blue to-[#1d3d68] text-white shadow-sm shadow-lbs-blue/20 hover:brightness-[1.1] hover:shadow-md hover:shadow-lbs-blue/30 active:brightness-[0.92]',
        secondary:
        ...
        link: 'text-lbs-blue underline-offset-4 hover:underline hover:text-[#1d3d68] active:opacity-70 dark:text-blue-300',
        destructive:
