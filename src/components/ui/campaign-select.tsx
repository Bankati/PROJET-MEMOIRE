...
export const CampaignSelect = ({
  ...
  return (
    <div ref={wrapperRef} className="relative">
      ...
      >
        <span className={selectedId.length > 0 ? "text-zinc-900 dark:text-zinc-100" : "text-zinc-400 dark:text-zinc-500"}>
          {displayLabel}
        </span>
        ...
        <div className="absolute left-0 top-full z-50 mt-1 w-full rounded-xl border border-zinc-200 bg-white shadow-xl dark:border-white/10 dark:bg-[#1a2332]">
          ...
          <ul className="max-h-52 overflow-y-auto p-1">
            ...
            {filteredOptions.length === 0 ? (
              <li className="px-3 py-4 text-center text-sm text-zinc-400">Aucune campagne trouvée</li>
            ) : (
