...
export function LiveHeroBg() {
  ...
  if (prefersReducedMotion) {
    return (
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-60 right-[-10%] h-[700px] w-[700px] rounded-full bg-[radial-gradient(circle_at_center,rgba(33,65,108,0.14),transparent_60%)] blur-3xl" />
  ...
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div
        aria-hidden
        className="absolute -bottom-60 right-[-10%] h-[700px] w-[700px] rounded-full bg-[radial-gradient(circle_at_center,rgba(33,65,108,0.14),transparent_60%)] blur-3xl"
        animate={{
          scale: [1.04, 1, 1.04],
          x: [0, -24, 0],
          y: [0, 16, 0],
