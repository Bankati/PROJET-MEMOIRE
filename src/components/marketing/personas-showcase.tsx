  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0" aria-hidden>
        <div className="bg-lbs-blue/12 absolute top-0 -left-40 h-[600px] w-[600px] rounded-full blur-[120px]" />
        <div className="absolute top-1/3 -right-32 h-[500px] w-[500px] rounded-full bg-violet-500/10 blur-[100px]" />
        <div className="bg-lbs-red/8 absolute -bottom-20 left-1/3 h-[500px] w-[500px] rounded-full blur-[100px]" />
        <div className="absolute top-20 right-1/4 h-[400px] w-[400px] rounded-full bg-emerald-500/8 blur-[100px]" />
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <motion.div
          ...
          className="max-w-3xl"
        >
          <div className="border-lbs-blue/20 bg-lbs-blue/5 text-lbs-blue inline-flex items-center gap-2 rounded-full border px-4 py-1.5 text-xs font-semibold tracking-[0.15em] uppercase backdrop-blur-sm">
            <span className="relative flex size-2">
              <span className="bg-lbs-blue absolute inline-flex size-full animate-ping rounded-full opacity-75" />
              <span className="bg-lbs-blue relative inline-flex size-2 rounded-full" />
            </span>
            Équipes & rôles
          </div>
          <h2 className="mt-5 text-3xl font-bold tracking-tight text-zinc-900 md:text-4xl lg:text-5xl dark:text-white">
            Conçu pour{' '}
            <span className="from-lbs-blue to-lbs-red bg-gradient-to-r via-violet-600 bg-clip-text text-transparent">
              chaque profil
            </span>
          </h2>
          <p className="mt-5 max-w-2xl text-lg leading-relaxed text-pretty text-zinc-600 dark:text-zinc-300">
            Même produit, des écrans et des indicateurs qui parlent le langage du métier — du
          ...
          {personas.map((persona, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Indicateur actif */}
                <div
                  className={`absolute top-0 left-0 h-full w-1 rounded-l-2xl transition-all duration-500 ${isActive ? styles.indicator : 'bg-transparent'}`}
                />
                      ...
                      <div className="mt-6 grid gap-5 lg:grid-cols-2">
                        ...
                        <div className="relative overflow-hidden rounded-xl">
                          ...
                          >
                            ...
                            />
                            <div
                              className={`absolute inset-0 rounded-xl bg-gradient-to-tr ${styles.gradient}`}
                            />
                          </motion.div>
                        </div>
                        {/* Bullets animées */}
                        <div className="flex flex-col justify-center gap-3">
                          {persona.bullets.map((bullet, bulletIdx) => (
                            ...
                            >
                              <span
                                className={`mt-0.5 grid size-6 shrink-0 place-items-center rounded-lg ${styles.bullet}`}
                              >
                                <Check className="size-3.5" strokeWidth={3} />
                              </span>
                              <span className="text-sm leading-relaxed font-medium text-zinc-800 dark:text-zinc-200">
                                {bullet}
                              </span>
                            </motion.div>
                          ))}
