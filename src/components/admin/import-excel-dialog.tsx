...
export const ImportExcelDialog = ({ campaigns }: ImportExcelDialogProps): React.JSX.Element => {
  ...
  return (
    <>
      ...
      <FormDialog
        ...
        icon={<Upload className="text-lbs-blue size-5 dark:text-blue-300" />}
        maxWidth="max-w-lg"
      >
        {result ? (
          ...
          <div className="space-y-4">
            ...
            >
              ...
              {file ? (
                ...
                <>
                  <UploadCloud
                    className={`mx-auto mb-3 size-10 ${isDragging ? 'text-lbs-blue dark:text-blue-400' : 'text-zinc-400 dark:text-zinc-500'}`}
                  />
