    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <a
          ...
          className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-1.5 text-sm font-medium text-emerald-700 transition hover:bg-emerald-100 dark:border-emerald-500/30 dark:bg-emerald-500/10 dark:text-emerald-300"
        >
          <MessageCircle className="size-4" /> WhatsApp
        </a>
      </div>

      {/* 3-panel layout : stack on mobile, 4-col grid on lg */}
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  ...
                  {contact.phoneSecondary ? (
                    <p className="text-xs text-zinc-500">{contact.phoneSecondary}</p>
                  ) : null}
                </div>
              </div>
              {contact.email ? (
                <div className="flex items-start gap-2.5">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium break-all text-zinc-800 dark:text-white">
                      {contact.email}
                    </p>
                  </div>
                </div>
