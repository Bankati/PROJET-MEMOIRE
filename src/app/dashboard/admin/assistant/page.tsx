      ...
      <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            Chat RAG en temps réel · Base de connaissances LBS
          </p>
        </div>
        <div className="flex shrink-0 items-center gap-1 rounded-xl border border-zinc-200 bg-zinc-100 p-1 dark:border-white/10 dark:bg-white/5">
          <button
            type="button"
              ...
              <div className="mb-5 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-500 dark:text-zinc-400">
                    Importez des PDF pour alimenter l&apos;assistant IA utilisé par les agents en
                    appel
                  </p>
                </div>
              </div>
