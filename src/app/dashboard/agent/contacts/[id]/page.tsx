...
export default async function AgentContactDetailPage({ params }: PageProps): Promise<React.JSX.Element> {
  const user = await requireRole({ allowedRoles: ["agent"] });
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {contact.phoneSecondary ? (
                    <p className="text-xs text-zinc-400 dark:text-zinc-500">{contact.phoneSecondary}</p>
                  ) : null}
                </div>
              </div>
