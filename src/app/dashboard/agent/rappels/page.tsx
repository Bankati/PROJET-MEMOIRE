...
import { callResults, campaigns, campaignContacts, contacts } from "@/db/schema";
              ...
              {rappels.length === 0 ? (
                <tr>
                  <td colSpan={7} className="px-5 py-10 text-center">
                    ...
                    <p className="text-xs text-zinc-300 dark:text-zinc-500">Les rappels s&apos;ajoutent automatiquement quand vous enregistrez un résultat &quot;Rappel&quot;.</p>
                  </td>
                </tr>
              ) : (
                rappels.map((r) => (
                  <tr key={r.callId} className="border-b border-zinc-100 transition hover:bg-zinc-50/50 dark:border-white/5 dark:hover:bg-white/5">
                    ...
                    <td className="px-5 py-3 text-right">
                      <Link
                        href={`/dashboard/agent/contacts/${r.ccId}`}
