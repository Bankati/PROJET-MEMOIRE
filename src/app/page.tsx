...
const features: readonly Feature[] = [
  ...
  },
  {
    title: "KPI par rôle",
    description:
      "Super-Admin, Admin, Agent: dashboards différenciés pour piloter la performance.",
  ...
  },
  {
    ...
    description:
      "Exports PDF, vues synthèse, et cartographie des établissements pour les admins.",
    icon: MapPinned,
...
const statToneClasses: Record<
  StatTone,
  Readonly<{ card: string; iconWrap: string }>
> = {
  blue: {
    ...
    iconWrap:
      "bg-lbs-blue/15 text-lbs-blue dark:bg-lbs-blue/25 dark:text-blue-200",
  },
  emerald: {
  ...
  rose: {
    ...
    iconWrap:
      "bg-rose-500/15 text-lbs-red dark:bg-rose-400/20 dark:text-rose-200",
  },
};
...
export default function HomePage() {
  return (
    <div className="min-h-full text-zinc-950 dark:text-zinc-50">
      ...
      <main>
        {/* ════════════════════ HERO ════════════════════ */}
        <section className="relative overflow-hidden pt-16" style={{ background: "linear-gradient(180deg, var(--section-cool) 0%, var(--background) 100%)" }}>
          <LiveHeroBg />
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:py-28">
            <HeroIntro>
              ...
              <div>
                <h1 className="text-balance text-4xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-5xl lg:text-6xl">
                  Modernisez votre prospection{" "}
                  <GradientText>avec l&apos;IA</GradientText>
                </h1>
              </div>

              <div>
                <p className="mt-6 max-w-xl text-pretty text-lg leading-8 text-zinc-600 dark:text-zinc-300">
                  LBS Call Center est la plateforme de prospection téléphonique
                  des établissements d&apos;enseignement supérieur. Campagnes
                  intelligentes, attribution fluide, assistant IA en temps réel
                  et KPI par rôle.
                </p>
              </div>
              ...
              <div>
                <div className="mt-8 flex flex-wrap items-center gap-5 text-sm text-zinc-600 dark:text-zinc-400">
                  <div className="flex items-center gap-2">
                    <CheckCircle2 className="size-4 text-lbs-blue" />
        ...
        <section className="relative overflow-hidden border-y border-lbs-blue/10 py-16" style={{ background: "linear-gradient(90deg, rgba(36,73,118,0.06) 0%, rgba(128,0,0,0.04) 50%, rgba(34,197,94,0.04) 100%)" }}>
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-0 top-0 h-full w-1/3 bg-gradient-to-r from-lbs-blue/5 to-transparent" />
        ...
        <section
          ...
          style={{ background: "linear-gradient(180deg, var(--background) 0%, var(--section-warm) 40%, var(--section-cool) 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute right-0 top-20 h-[400px] w-[400px] rounded-full bg-lbs-red/6 blur-[100px]" />
            <div className="absolute left-0 bottom-20 h-[400px] w-[400px] rounded-full bg-lbs-blue/6 blur-[100px]" />
          </div>
            ...
            <div className="mt-16 grid gap-6 lg:grid-cols-2">
              <Reveal>
                <GlowCard className="h-full" glowColor="rgba(128, 0, 0, 0.12)">
                  <div className="p-8">
                    <div className="mb-4 grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-red-100 to-red-50 text-lbs-red shadow-sm dark:from-red-950/60 dark:to-red-950/30">
                    ...
                    <p className="mt-3 leading-relaxed text-zinc-600 dark:text-zinc-300">
                      Fichiers Excel éparpillés, doublons non détectés, pas de
                      script standardisé, aucune visibilité sur la performance
                      des agents. Les responsables naviguent à l&apos;aveugle et les
                      conversions stagnent.
                    </p>
                    <div className="mt-6 flex flex-wrap gap-2">
                      {["Doublons", "Pas de KPI", "Fichiers Excel", "Aucun suivi"].map(
                        (pain) => (
                          <span
                            key={pain}
                            className="rounded-full border border-red-200/60 bg-red-50/80 px-3 py-1 text-xs font-medium text-lbs-red dark:border-red-800/40 dark:bg-red-950/30"
                          >
                            {pain}
                          </span>
                        ),
              ...
              <Reveal delay={0.08}>
                <GlowCard className="h-full" glowColor="rgba(36, 73, 118, 0.14)">
                  <div className="p-8">
                    <div className="mb-4 grid size-12 place-items-center rounded-2xl bg-gradient-to-br from-blue-100 to-blue-50 text-lbs-blue shadow-sm dark:from-lbs-blue/30 dark:to-lbs-blue/15">
                    ...
                    <p className="mt-3 leading-relaxed text-zinc-600 dark:text-zinc-300">
                      Rôles clairs, attribution fluide des contacts, scripts de
                      campagne structurés et assistant IA (RAG) qui aide l&apos;agent
                      pendant l&apos;appel. Le pilotage KPI fiable permet aux
                      responsables de prendre des décisions éclairées.
                    </p>
                    <div className="mt-6 flex flex-wrap gap-2">
                      {[
                        "0 doublon",
                        ...
                        <span
                          key={benefit}
                          className="rounded-full border border-lbs-blue/25 bg-lbs-blue/5 px-3 py-1 text-xs font-medium text-lbs-blue dark:border-lbs-blue/30 dark:bg-lbs-blue/15"
                        >
                          {benefit}
                        </span>
                      ))}
        ...
        <section
          className="relative overflow-hidden py-20 lg:py-28"
          style={{ background: "linear-gradient(135deg, #0c1929 0%, #142640 40%, #1a1030 70%, #0f0a1a 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute -left-32 top-10 h-[500px] w-[500px] rounded-full bg-lbs-blue/15 blur-[120px]" />
            <div className="absolute right-0 bottom-0 h-[400px] w-[400px] rounded-full bg-violet-600/10 blur-[100px]" />
            <div className="absolute left-1/2 top-0 h-px w-3/4 -translate-x-1/2 bg-gradient-to-r from-transparent via-lbs-blue/30 to-transparent" />
          ...
          <div className="relative mx-auto max-w-6xl px-4 sm:px-6">
            <Reveal>
              <div className="max-w-3xl text-center mx-auto">
                <Badge className="mb-4 border-lbs-blue/30 bg-lbs-blue/15 text-blue-200">
                  En 3 étapes
                </Badge>
                ...
                <p className="mt-4 text-pretty text-lg leading-relaxed text-zinc-300">
                  Un flux simple pour gagner du temps, améliorer la qualité des appels et suivre l&apos;impact sur les inscriptions.
                </p>
              </div>
            </Reveal>
              ...
              <div className="relative overflow-hidden rounded-3xl border border-white/10 shadow-2xl shadow-black/40">
                ...
                <div className="absolute inset-x-0 bottom-0 p-8">
                  <div className="grid gap-3 md:grid-cols-3">
                    <DarkGlassMiniCard title="Attribution fluide" desc="Contacts distribués, suivi clair." />
                    <DarkGlassMiniCard title="Assistance IA" desc="Réponses contextualisées (RAG)." />
                    <DarkGlassMiniCard title="KPI en temps réel" desc="Performances par rôle et campagne." />
                  </div>
                </div>
              </div>
            </Reveal>
        ...
        <section
          id="fonctionnalites"
          className="scroll-mt-20 relative overflow-hidden py-20 lg:py-28"
          style={{ background: "linear-gradient(180deg, var(--section-cool) 0%, var(--background) 40%, var(--section-warm) 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-1/4 top-0 h-[500px] w-[500px] rounded-full bg-lbs-blue/5 blur-[120px]" />
            ...
            <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              ...
              <Reveal>
                <div className="flex flex-wrap gap-2">
                  {[
                    { tag: "Import Excel", color: "border-lbs-blue/30 bg-lbs-blue/5 text-lbs-blue" },
                    { tag: "KPI", color: "border-emerald-500/30 bg-emerald-500/5 text-emerald-700 dark:text-emerald-300" },
                    { tag: "RAG", color: "border-violet-500/30 bg-violet-500/5 text-violet-700 dark:text-violet-300" },
                    { tag: "Exports", color: "border-amber-500/30 bg-amber-500/5 text-amber-700 dark:text-amber-300" },
            ...
            <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              {features.map((f, idx) => (
                <Reveal key={f.title} delay={idx * 0.04}>
                  <Card className="group h-full overflow-hidden border-0 shadow-lg shadow-zinc-900/5 ring-1 ring-zinc-200/80 transition-all duration-500 hover:shadow-xl hover:shadow-lbs-blue/10 dark:bg-zinc-900/60 dark:shadow-black/30 dark:ring-zinc-800 dark:hover:shadow-lbs-blue/5">
                    <div className="relative h-44 w-full overflow-hidden sm:h-48">
                      ...
                      <div className="absolute bottom-3 left-3 grid size-11 place-items-center rounded-xl bg-white/95 text-lbs-blue shadow-lg transition-transform duration-300 group-hover:scale-110 dark:bg-zinc-900/95 dark:text-white">
                    ...
                    <CardContent className="pb-5">
                      <div className="flex items-center gap-3 border-t border-zinc-100 pt-4 dark:border-zinc-800">
                        <Sparkles className="size-4 shrink-0 text-lbs-blue" />
                        <span className="text-xs font-medium text-lbs-blue transition-colors group-hover:text-lbs-red">
                          En savoir plus →
                        </span>
                      </div>
                    </CardContent>
                    <div className="h-0.5 w-full bg-gradient-to-r from-lbs-blue via-violet-500 to-lbs-red opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                  </Card>
                </Reveal>
              ))}
            </div>
        ...
        <section
          id="avantages"
          className="scroll-mt-20 relative overflow-hidden py-20 lg:py-28"
          style={{ background: "linear-gradient(180deg, var(--section-warm) 0%, var(--section-accent) 50%, var(--section-cool) 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-0 top-1/2 h-[400px] w-[400px] -translate-y-1/2 rounded-full bg-amber-400/8 blur-[100px]" />
            <div className="absolute right-0 top-1/4 h-[400px] w-[400px] rounded-full bg-emerald-500/6 blur-[100px]" />
          </div>
        ...
        <section
          className="relative overflow-hidden py-20 lg:py-28"
          style={{ background: "linear-gradient(180deg, var(--section-cool) 0%, var(--background) 60%, var(--section-warm) 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute left-1/2 top-0 h-px w-2/3 -translate-x-1/2 bg-gradient-to-r from-transparent via-lbs-blue/15 to-transparent" />
            <div className="absolute right-0 top-1/3 h-[500px] w-[500px] rounded-full bg-violet-500/5 blur-[120px]" />
          </div>
        ...
        <section
          id="demo"
          className="scroll-mt-20 relative overflow-hidden py-20 lg:py-28"
          style={{ background: "linear-gradient(135deg, #0c1929 0%, #142640 35%, #1a1030 65%, #200c10 100%)" }}
        >
          <div className="pointer-events-none absolute inset-0" aria-hidden>
            <div className="absolute -left-20 top-20 h-[500px] w-[500px] rounded-full bg-lbs-blue/15 blur-[120px]" />
            <div className="absolute -right-20 bottom-10 h-[400px] w-[400px] rounded-full bg-lbs-red/12 blur-[100px]" />
            <div className="absolute left-1/2 top-1/3 h-[300px] w-[300px] -translate-x-1/2 rounded-full bg-violet-600/10 blur-[80px]" />
            <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.03)_1px,transparent_0)] [background-size:24px_24px]" />
          </div>
                ...
                <div className="relative grid gap-8 p-8 md:grid-cols-2 md:items-center md:p-12 lg:p-16">
                  <div>
                    ...
                    <p className="mt-4 text-lg leading-relaxed text-zinc-300">
                      Demandez une démo et découvrez comment l&apos;IA et les KPI
                      par rôle peuvent moderniser votre centre d&apos;appels.
                    </p>
                    <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                      <Button asChild size="lg" className="group">
                        <Link href="#demo">
                  ...
                  <div className="rounded-2xl border border-white/10 bg-white/5 p-6 shadow-lg backdrop-blur-xl">
                    <div className="flex items-center gap-3">
                      <div className="grid size-11 place-items-center rounded-xl bg-lbs-blue/20">
                    ...
                    <div className="mt-5 rounded-xl border border-white/10 bg-white/5 p-4 text-sm leading-relaxed text-zinc-200">
                      &quot;Donne‑moi un argumentaire sur les débouchés du
                      Master X.&quot;
          ...
          <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
            <div className="grid gap-8 md:grid-cols-3">
              <div>
                ...
                <p className="mt-4 max-w-xs text-sm leading-relaxed text-zinc-400">
                  La plateforme de prospection téléphonique conçue pour les
            ...
            <div className="mt-10 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-8 sm:flex-row">
              <p className="text-xs text-zinc-500">
                © {new Date().getFullYear()} LBS Call Center — Lomé Business
                School. Projet mémoire.
              </p>
...
function ProofMetric({
  ...
  return (
    <div className="text-center">
      <p className={`text-2xl font-bold tracking-tight md:text-3xl ${color}`}>
        {value}
      </p>
      ...
      >
        <CardHeader>
          <div className="flex items-center justify-between gap-3">
            ...
            <div
              className={`grid size-10 shrink-0 place-items-center rounded-xl ${t.iconWrap}`}
            >
...
function ValuePropCard({
  ...
  return (
    <Card className="group h-full overflow-hidden border-0 shadow-lg ring-1 ring-zinc-200/80 transition-all duration-500 hover:shadow-xl hover:shadow-lbs-blue/10 dark:bg-zinc-900/50 dark:ring-zinc-800">
      <div className="relative h-44 w-full overflow-hidden sm:h-48">
        <Image
          src={image}
          alt={imageAlt}
  ...
  return (
    <div className="group relative rounded-2xl border border-white/10 bg-white/5 p-6 shadow-lg backdrop-blur-sm transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/8 hover:shadow-xl">
      <div className="flex items-start gap-4">
        <div className={`grid size-12 shrink-0 place-items-center rounded-2xl bg-gradient-to-br ${accentGradient} text-white shadow-lg transition-transform duration-300 group-hover:scale-110`}>
